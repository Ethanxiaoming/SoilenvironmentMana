...
public class SectionElemserviceImpl implements SectionElemService {
	...
	public List<BasicInfo> findBasicInfo(int year, String regionName) {
		...
		List<BasicInfo> resultmap = getBasicInfoData(year, regionName, result);
		return resultmap;
	}
	
	@Override
	public List<BasicInfo> findBasicInfo(int year, String regionName,String towns) {
		List<EleofsectionWithrg> result = sectiondao.selectInfoOfRegionbytowns(year, regionName,towns);
		List<BasicInfo> resultmap = getBasicInfoData(year, regionName, result);
		return resultmap;
	}
	
	private List<BasicInfo> getBasicInfoData(int year, String regionName, List<EleofsectionWithrg> result) {
